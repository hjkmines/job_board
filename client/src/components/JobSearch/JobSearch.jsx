...
export default function App() {
    ...
    return (
        <MDBContainer fluid className='search2 border-2 p-4'>
            <form className='searchForm' onSubmit={handleSearch} >

                {/* first row - searchbutton and search input */}
                {/* 1st row. Search button and search input  */}
                <MDBRow className='searchRow1 '>
                    <MDBCol size={4} className='searchBtnCol justify-content-end'>
                        <MDBContainer className='d-flex p-0 bg-white searchContainer'>
                ...
                {/* second row */}
                <MDBRow className='d-flex mt-2 align-items-center justify-content-start border border-white'>
                    <MDBCol size={2} className="d-flex align-items-center ">
                    <div className="me-4" style={{fontWeight: '700'}}>Filters:</div>
                        <div className="me-2" style={{fontWeight: '700'}}>Remote Only</div>
                        <MDBSwitch  id="remoteWork" btnColor='secondary' value={'Remote Only'} aria-label='remote work toggle' name='remote' />
                    </MDBCol>
