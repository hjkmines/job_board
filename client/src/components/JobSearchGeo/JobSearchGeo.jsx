  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      if (geoLocationChecked) {
        values.geoLocation = true;
        values.remoteOnly = null;
              ...
              <MDBRow className=" d-flex justify-content-center  align-items-end">
                <MDBCol size={2} md={1} className=" d-lg-none d-xs-block">
                  <MDBBtn
                    ...
                    size="lg"
                    type="submit"
                    className="action-btn  shadow-none "
                  >
                ...
                <MDBCol size={1} lg={2} xl={4} className=" d-none d-lg-block">
                  <MDBBtn
                    ...
                    size="lg"
                    type="submit"
                    className="action-btn fw-bold  shadow-none w-100"
                  >
                    Search
                  </MDBBtn>
                </MDBCol>
              ...
              <MDBRow className="d-flex justify-content-center align-items-end  ">
                ...
                <MDBCol xl={2} md={3} sm={4}>
                  <div className="form-group ">
                    <label htmlFor="radius" className="fw-bold">
                      Within
                    </label>

                    <select
                      className="form-select select-round"
                      name="radius"
                      id="radius"
                      onChange={formik.handleChange}
                ...
                <MDBCol xl="2" md={2} size={6}>
                  {/* geoLocation switch */}
                  <label htmlFor="geoLocation" className="fw-bold">
                    Your location
                  </label>
                ...
                {/* Remote switch */}
                <MDBCol xl={2} md={2} size={6}>
                  <label htmlFor="remote" className="fw-bold">
                    Remote only
                  </label>
